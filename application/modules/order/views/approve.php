    ...
    <div class="col-sm-10 col-lg-8">
        <ul class="list-group">
            <li class="list-group-item">
                ...
                <div>
                    <div class="radio">
                    <label><input type="radio" name="approve" checked="checked" value="agree">Agree</label>
                    </div>

                    <div class="radio">
                    <label><input type="radio" name="approve" value="disagree">Disagree</label>
                    </div>

                    <div class="radio">
                    <label><input type="radio" name="approve" value="finish">Finish</label>
                    </div>
                </div>
            </li>';
echo '
