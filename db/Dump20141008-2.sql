...
INSERT INTO `inkiu_account` VALUES (8,'fdg',NULL,NULL,NULL,'/','fd',1),(31,'dsf',NULL,NULL,'8','/manhnd','bbb',2),(32,'sdf',NULL,NULL,'31','/manhnd/bbb','sadf',3),(64,'dump',NULL,NULL,'33','manhnd/manhnd1/manh/','1111',3),(66,'dump',NULL,NULL,'33','manhnd/manhnd1/fdg/','dfg',3);
...
-- Dump completed on 2014-10-08 11:08:26
CREATE DATABASE  IF NOT EXISTS `irbs_testing` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `irbs_testing`;
-- MySQL dump 10.13  Distrib 5.5.38, for debian-linux-gnu (x86_64)
--
-- Host: 123.30.238.216    Database: irbs_testing
-- ------------------------------------------------------
-- Server version	5.5.31
